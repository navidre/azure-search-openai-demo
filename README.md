...
### My Steps:
1. Locally open in dev container using VS Code
2. Make sure `azd auth login` is done
3. Go to `app` folder and run `bash start.sh`
4. Open the browser and go to `http://localhost:50505/`